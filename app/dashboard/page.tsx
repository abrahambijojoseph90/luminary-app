...
export default async function DashboardPage() {
  ...
  const nextModule = dbModules.find((m) => !completedIds.includes(m.id));

  const currentPhase = PHASES.find((ph) =>
    dbModules.some((m) => m.phase === ph.id && !completedIds.includes(m.id))
    ...
    <div className="min-h-screen lg:pl-56" style={{ background: "#07090f" }}>
      ...
      <main className="px-4 md:px-8 py-8 pb-24 lg:pb-8 max-w-6xl mx-auto">
        <div className="mb-10 animate-fade-up">
          ...
          <h1 className="font-display text-4xl font-bold mb-2" style={{ color: "#e8e4d9" }}>{firstName}.</h1>
          <p style={{ color: "#6b7280" }}>
            {completedCount === 0 ? "Your leadership journey begins here."
              : completedCount === totalCount ? "You've completed all modules. Remarkable."
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 animate-fade-up-2">
              {[
                ...
                <div key={stat.label} className="rounded-2xl p-4" style={{ background: "#0d1021", border: "1px solid #1e2540" }}>
            ...
            {nextModule && (
              <div className="rounded-2xl p-6 animate-fade-up-3"
                ...
                <p className="text-xs uppercase tracking-widest mb-3" style={{ color: "#c49a3c" }}>↗ Up Next</p>
                <h2 className="font-display text-2xl font-semibold mb-1" style={{ color: "#e8e4d9" }}>{nextModule.title}</h2>
                  ...
                  return (
                    <div key={phase.id}>
                      <div className="flex justify-between items-center mb-1.5">
                        ...
                        <span className="text-xs font-mono" style={{ color: "#6b7280" }}>{done}/{phaseModules.length}</span>
                      </div>
          ...
          <div className="space-y-6">
            <div className="rounded-2xl p-6 animate-fade-up-2" style={{ background: "#0d1021", border: "1px solid #1e2540" }}>
            ...
            <div className="rounded-2xl p-6 animate-fade-up-3" style={{ background: "#0d1021", border: "1px solid #1e2540" }}>
