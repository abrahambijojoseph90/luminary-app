...
export const PHASES: Phase[] = [
  { id: 1, label: "Phase 1", name: "Foundation", color: "#c49a3c", modules: [1, 2, 3] },
  { id: 2, label: "Phase 2", name: "Growth", color: "#6eb5ff", modules: [4, 5, 6] },
  { id: 3, label: "Phase 3", name: "Mastery", color: "#7defa8", modules: [7, 8, 9, 10] },
];
...
export function computeSkillLevels(completedModuleIds: number[]): Record<SkillId, number> {
